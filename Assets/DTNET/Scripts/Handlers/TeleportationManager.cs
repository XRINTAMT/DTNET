...
namespace DTNET.Handlers {
    public class TeleportationManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if(!rayInteractor.GetCurrentRaycastHit(out RaycatHit hit))
            {
                rayInteractor.enable = false;
                _isActive = false;
            }
            ...
            {
                destinationPostition = hit.point,
            }
