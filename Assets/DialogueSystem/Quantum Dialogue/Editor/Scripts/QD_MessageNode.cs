...
namespace QuantumTek.QuantumDialogue.Editor
{
    ...
    public class QD_MessageNode : QD_Node
    {
        ...
        public override void DrawWindow(int id)
        {
            ...
            //EditorGUI.LabelField(new Rect(5, 170, 190, 20), "Event", QD_DialogueEditor.skin.label);
            //string fMessage2 = EditorGUI.TextArea(new Rect(5, 195, 190, 65), Data.MessageText, QD_DialogueEditor.skin.textArea);
